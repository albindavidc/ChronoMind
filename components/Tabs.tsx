...
import { Timer, Watch, Settings } from 'lucide-react';
  ...
  return (
    <div className="flex items-center justify-center gap-1.5 p-1.5 mx-auto bg-gray-900/60 backdrop-blur-xl border border-white/10 rounded-full shadow-2xl">
      <button
        ...
        className={`flex items-center justify-center gap-2 px-5 py-2.5 rounded-full transition-all duration-300 border ${
          activeTab === 'timer' 
